import SinglePubCard from '../components/PubCard';
...
Previously, I received my Master's degree in Computer Science from Waseda University, where I was advised by [Prof. Tatsuo Nakajima](https://scholar.google.com/citations?user=hVxdgeYAAAAJ&hl=en). I earned my bachelor's degree from the Electronic Information School at Wuhan University, supervised by [Prof. Guangyi Yang](https://scholar.google.com/citations?user=DiqJdPEAAAAJ&hl=en&view_op=list_works&sortby=pubdate). I was a research intern at Hong Kong University of Science and Technology, under the guidance of [Prof. Lik-Hang Lee](https://www.lhlee.com/) and [Prof. Pan Hui](https://panhui.people.ust.hk/index.html).

I'm generally interested in eXtended Reality, User Interface, and Human-AI interaction.
More specifically, I'm currently exploring:

- Intuitive and effective interfaces for _learning in XR_
- _Educational AI agents_ in interactive systems
...
<CardList>
  ...
  <SinglePubCard
    ...
    author="Qiao Jin, Yang Zhan, Will Morgus, Kyle Price, Michael Sandbothe, Jonathan Sewall, Octav Popescu, Susan Berman, Stephen E. Fancsali, Steve Ritter, Kenneth Holstein, Vincent Aleven"
    conference="AIED 26"
    description="An in-the-wild field study of MR-supported teacher orchestration in AI-supported classrooms, examining how teachers and students experienced MR learning status cues in authentic classroom. The study highlights the value of real-time awareness and flexible co-teaching support."
    imagePaths={imagePaths.get('mr-its')}
    link="https://doi.org/10.1007/978-3-032-29770-9_36"
    pdfPath="/papers/mr_its.pdf"
    techIcon="unity"
  />

<SinglePubCard
  title="Understanding Prompt Construction and Interaction Challenges in LLM-Based Multi-Robot Systems for Spatial Tasks"
  author={'Xiaoran Yang, Yang Zhan, Qiao Jin'}
  conference="CHI EA 26"
  description="A qualitative study on LLM-based multi-robot systems. Our findings highlight how users prompt for coordination and reveal that gaps in system visibility necessitate better interface and prompting support."
  imagePaths={imagePaths.get('multi-robot')}
  link="https://doi.org/10.1145/3772363.3798326"
  pdfPath="/papers/prompt_multi_robot.pdf"
  techIcon="unreal,python"
/>
  ...
  <SinglePubCard
    ...
    link="https://link.springer.com/chapter/10.1007/978-3-032-11768-7_3"
  ...
  <SinglePubCard
    ...
    link="https://ieeexplore.ieee.org/document/11303509"
